...
public class MainActivity extends AppCompatActivity {
    ...
    private Button buttonFoto, buttonSubmit;
    ...
    private void sendData() {
        ...
        if (ra.isEmpty() || !ra.matches("\\d{1,8}")) {
            Toast.makeText(MainActivity.this, "Apenas 8 números são permitidos no campo \"ra\"", Toast.LENGTH_LONG).show();
            return;
        }
        ...
        intent.putExtra("sexo", radioButtonMasculino.isChecked() ? "M" : "F");
